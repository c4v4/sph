#ifndef SCP_INCLUDE_TWOPHASE_HPP_
#define SCP_INCLUDE_TWOPHASE_HPP_
...
public:
    ...
    GlobalMultipliers& get_global_u() { return glo_u; }
...
private:
    ...
    template <typename Collection, typename Sol>
    void check_integrity(Collection& cols, Sol sol) {
        MStar cov;
        cov.reset_covered(cols, sol, subinst.get_instance().get_nrows());
