...
GlobalSolution TwoPhase::operator()(const real_t global_UB, GlobalSolution& S_star) {
...
void TwoPhase::cplex_heur(LocalSolution& S_init, GlobalSolution& S_star, real_t& glb_UB_star) {
